...
namespace Atleti_AspMVC.Controllers
{
    public class AthletesController : Controller
    {
        ...
        //al richiamo del click verso submit post richiamo questo metodo
        [HttpPost]
        ...
        {
            var results = db.Athletes.Where(o => o.Name.Contains(searchString)).OrderBy(O=>O.Name); //contains è come like in sql
        ...
        {
            var athletes = db.Athletes.Include(a => a.Nationality).Include(a => a.Sport);
